...
class GMixFitCoellipTry:
    ...
    def get_ydiff(self, pars):
        ...
        yd=(model-self.image).reshape(self.image.size)
        #wbad=where(isfinite(yd) == False)
        #if wbad[0].size > 0:
        #    print >>stderr,'found NaN in ydiff'
        #    stop
        return yd
